            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <div class="row m-b-10">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <h4 style="margin-bottom: 0px;"><b>Vendor : {{ $vendor }}</b></h4>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <h4><b>Issue Status : {{ $issue_status }}</b></h4>
                        </div>
                    </div>
                            ...
                            <table id="data-table" class="table display-data-table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="25%" style="text-align: center;">Document Number</th>
                                        <th width="25%" style="text-align: center;">Document Title</th>
                                        <th width="30%" style="text-align: center;">Existing or New Document</th>
                                        <th width="15%" style="text-align: center;">Document File</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if (count($temp) == 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if ($row->status == 1) 
                                                <input type="file" class="form-control mandatory-input" placeholder="File" id="document_no" name="document_migration_{{$row->id}}" value="" onkeypress="return handleEnter(this, event)" style="margin-bottom: 5px; width:170px;">
                                            @else
                                                <input type="file" class="form-control" placeholder="File" id="document_no" name="document_migration[]" disabled value="" onkeypress="return handleEnter(this, event)" style="margin-bottom: 5px; width:170px;">
                                            @endif
