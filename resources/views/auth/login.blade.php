        ...
        <div class="login login-with-news-feed">
            ...
            <div class="right-content">
                ...
                <div class="login-content">
                    <form method="POST" action="{{ route('login') }}" class="margin-bottom-0" id="myform" name="myform" autocomplete="off">
                        @csrf
                        <div class="form-group m-b-15">
                            {{--<input type="text" class="form-control input-lg mandatory-input first-selected style_form_input_email" placeholder="Email Address" id="email" name="email" />--}}
                            <input type="text" class="form-control input-lg mandatory-input first-selected style_form_input_email" placeholder="User Name" id="name" name="name" />
                        </div>
                        <div class="form-group m-b-15">
                            <input type="password" class="form-control input-lg mandatory-input style_form_input_password" placeholder="Password" id="password" name="password" />
                        </div>
                        ...
                        @endif
                        <div class="login-buttons">
                            <button type="submit" id="button_submit" class="btn btn-success btn-block btn-lg">Sign me in</button>
                        </div>
