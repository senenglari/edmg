                        ...
                        <table class="table table-bordered" id="table-document">
                            <thead>
                                <tr>
                                    ...
                                    <th width="" style="text-align: center;">Remark</th>
                                    <th width="15%" style="text-align: center;">File</th>
                                </tr>
                            </thead>
                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="text-align: center;" width="50%">&nbsp;
                                                        @if(!empty($row->document_file))
                                                            <a href="{{ url('').'/uploads'.$row->document_url.$row->document_file }}" target="_blank"><img src="{{ url('') . '/app/img/icon/eye.png'}}" alt="" width="16px"></a>
                                                        @endif
                                                    </td>
                                                    <td style="text-align: center;" width="50%">&nbsp;
                                                        @if(!empty($row->document_file_2))
                                                            <a href="{{ url('').'/uploads'.$row->document_url.$row->document_file_2 }}" target="_blank"><img src="{{ url('') . '/app/img/icon/eye.png'}}" alt="" width="16px"></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            </table>
