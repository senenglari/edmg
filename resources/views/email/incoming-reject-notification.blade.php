...
<table cellspacing="0" cellpadding="0" border="0" width="700px" style="top: 50%;left: 50%; ">
	<tr>
		<td style="background-color: #ffffff; font-weight: bold; font-size: 16px; padding: 30px; color: #00AF40; border-top: 1px solid #EDEDED; border-left: 1px solid #EDEDED; border-right: 1px solid #EDEDED; text-align: right;" colspan="2">{{ $title }}</td>
	</tr>
	<tr>
		<td colspan="2">{{ $ket_reject }}</td>
	</tr>
		...
		<td width="150" colspan="2" style="padding: 30px 0 0 30px;border-left: 1px solid #EDEDED; border-right: 1px solid #EDEDED;">
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<td style="border: 1px #00AF40 solid; border-right: 0; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; text-align: center; width: 100px;">Issue Issue</td>
				...
				@for($i=0; $i<count($list_doc); $i++)
				<tr>
					<td style="border: 1px #00AF40 solid; border-right: 0; border-top: 0; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; height: 30px; text-align: center;">{{ $list_doc[$i] }}</td>
					<td style="border: 1px #00AF40 solid; border-right: 0; border-top: 0; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; height: 30px; text-align: left;">&nbsp;&nbsp;{{ $list_title[$i] }}&nbsp;&nbsp;</td>
					<td style="border: 1px #00AF40 solid; border-right: 0; border-top: 0; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; height: 30px; text-align: center;">{{ $list_issue[$i] }}&nbsp;&nbsp;&nbsp;</td>
					<td style="border: 1px #00AF40 solid; border-top: 0; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; height: 30px; text-align: center;">{{ $list_status[$i] }}&nbsp;&nbsp;&nbsp;</td>
				</tr>
				@endfor
			</table>
		</td>
