...
$workPath="../public/uploads/document/5/support.pdf";
...
//$workPath = "../public/uploads/document/" . $pdf_id . "/" . $fileName; // kalau pakai public/uploads
...
//uploads/document/5/251230PNDAQPE9_4_20260107143216.pdf77
...
<script src="assets/vendor/interact/interact.min.js"></script>
<?php endif; ?>
...
document.addEventListener("adobe_dc_view_sdk.ready", function () {
  const adobeDCView = new AdobeDC.View({ clientId: ADOBE_KEY, divId: "adobe-dc-view" });
   //console.log(window.location.origin + BASE_URL + VIEW_URL);
   //http://dzaries.my.id:8000/uploads/document/5/251230PNDAQPE9_4_20260107143216.pdf77
   //http://dzaries.my.id/edmg-github-clone/edmg/pdf-stamp/storage/5/support.pdf772074155
   //http://dzaries.my.id:8000/uploads/document/48/0025-TR-POG-2025_RCV_0025-TR-POG-2025_20260202153844_20260226053618.pdfs
  adobeDCView.previewFile({
    ...
    embedMode: "FULL_WINDOW"
	  ...
	  console.log('Adobe previewFile success!');
...
async function renderStampPreview() {
  ...
  img.src = `assets/stamps/${type}.png`;
...
function initStampInteract() {
  ...
  document.getElementById('stamp-type').addEventListener('change', () => {
    const type = document.getElementById('stamp-type').value;
    document.getElementById('stamp-img').src = `assets/stamps/${type}.png`;
  });
}
...
window.addEventListener('load', function () {
  setTimeout(() => {
    alert("PDF kadang blank karena cache browser.\n\n" +
          "Cara cepat fix:\n" +
          "1. Tekan F12 (Inspect Element)\n" +
          "2. Pilih tab Network\n" +
          "3. Centang 'Disable cache' di atas\n" +
          "4. Tekan F5 untuk refresh\n\n" +
          "Atau coba refresh halaman ini beberapa kali sampai PDF muncul.");

    // Auto reload setelah alert ditutup (opsional, kalau mau lebih agresif)
