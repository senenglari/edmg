...
header("Expires: 0");
				...
				//redirect to-->http://dzaries.my.id/edmg-github-clone/edmg/pdf-stamp/index.php?pdf_id=18&fileName=TMBP-SP001-ME-DST-D115%20MECHANICAL%20DATASHEET%20FOR%20TEST%20PUMP%20KRG%20(P-003%20AB)_REV%20A%20(IFR)_20260119231547.pdf&lpath=SjBwZWVISldKa1FlS0Vnb2FTb0tiUzhoR1V0aWVYUkhjUQ==
...
async function applyStampToPdf() {
  ...
  try {
    ...
    window.location.href = "index.php?pdf_id=" + PDF_ID_NUM + "&rname=" + RNAME + "&idrole=" + IDROLE + "&iduser=" + IDUSER + "&stamp=1&fileName=" + FILENAME + "&lpath=" + LPATH;
    
    //pdf_id=1&rname=ADMIN&idrole=49&iduser=1&fileName=T124_normal.pdf&lpath=S0ZGaWYzWldKa1FlS0Vnb2FTb0tiUzhoR1V0aWVYUkhjUQ==
  } catch (e) {
