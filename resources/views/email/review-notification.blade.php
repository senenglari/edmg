		...
		<td width="150" colspan="2" style="padding: 30px 0 0 30px;border-left: 1px solid #EDEDED; border-right: 1px solid #EDEDED;">
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<td style="border: 1px #00AF40 solid; border-right: 0; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; text-align: center; width: 100px;">Doc Issue</td>
					<td style="border: 1px #00AF40 solid; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; text-align: center; width: 100px;">Doc Status</td>
				</tr>
				...
				<tr>
					...
					<td style="border: 1px #00AF40 solid; border-top: 0; color: #454545; font-family: Tahoma, Verdana, Arial, Helvetica, Sans-Serif; font-size: 11px; font-weight: bold; height: 30px; text-align: center;">{{ $row->document_status_name }}&nbsp;&nbsp;&nbsp;</td>
				</tr>
				@endforeach
			</table>
		</td>
